<template>
    ...
    <div class="conts" :class="{ open: open }">
        ...
        <ul class="rlist" v-show="open">
            <li v-for="item in list" :key="item.id" @click="openChat(item)" :class="{ cur: item.id === chatWindow.id }">
                <a class="user-head">
            ...
            <li>
                ...
                <a class="user-name" href="#">张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲张金玲</a>
            </li>-->
        </ul>
    </div>
    <!--
...
import { VIEW_STATE_CHANGE, VIEW_CHAT_OPEN } from '../store/mutations';
