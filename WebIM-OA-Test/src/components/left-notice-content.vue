            ...
            <li>
                <div class="noticewrap">
                    ...
                    <div class="noticecon2" v-if="item.card">
                        <a v-if="item.isLink" :href="item.message" target="_blank" :title="item.housetitle">
                            <div class="con">
                                <h6 v-text="item.card.title">item card title</h6>
                                <p v-text="item.card.desc">item card desc</p>
                            </div>
                            <div class="pic">
                                <img :src="item.card.pic" alt="">
                            </div>
                        </a>
                        <template v-else>
                            <div class="con">
                    ...
                    <div class="noticecon" v-else>
                        <p v-if="item.isLink">
                            <a :href="item.message" target="_blank" :title="item.housetitle" v-text="item.message">item message</a>
                        </p>
        ...
        <!--
            ...
            <li>
                <div class="noticewrap">
                    ...
                    <div class="noticecon">
                        <p><a href="#" title="">http://esf.fang.com/zt/201705/bjrmtjf.html?cms_uuid=201311339_bj_89785</a></p>
                    </div>
                    <div class="noticeimg">
        ...
        <!--
            ...
            <li>
                <div class="noticewrap">
                    ...
                    <div class="noticecon2">
                        <div class="con">
                            <h6>需求升级调整安排需求升级调整安排需求升级调整安排需求升级调整安排</h6>
                            <p>提供财经日历，最权威外汇实时行情资讯，财经数据，外汇保证分析评论,提供财经日历，最权威外汇实时行情资讯，财经数据，外汇保证分析评论</p>
                        </div>
