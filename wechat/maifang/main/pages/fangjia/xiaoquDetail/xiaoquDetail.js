...
let page = {
    ...
    data: {
        ...
        // 选择朝向
        selectInfo: {
            selectArr: [{ val: '东', id: '' }, { val: '南', id: '' }, { val: '西', id: '' }, { val: '北', id: '' }, { val: '东南', id: '' }, { val: '东北', id: '' }, { val: '西南', id: '' }, { val: '西北', id: '' }],
            currentSel: '南',
            showSelect: false
        },
        // 当前城市：跳转到附近小区用
    ...
    onLoad: function (options) {
        ...
        let pageInfoTask = new Promise((resolve, reject) => {
            ...
            wx.request({
                url: vars.interfaceSite + 'xqDetail',
                data: {
                    cityname: that.options.cityname,
                ...
                complete: res => {
                    ...
                    if (typeof resData === 'object') {
                        ...
                        } else if (!res[0].img || !res[0].img.all_picArr || !res[0].img.all_picArr.length) {
                            // 图片可能没有
                            !res[0].img && (res[0].img = {});
                            !res[0].img.all_picArr && (res[0].img.all_picArr = []);
                            // 设置默认图片
                            res[0].img.all_picArr.push('http://static.soufunimg.com/common_m/m_wechat/public/images/arr_right.png');
                        };
                        // 设置环比上月格式
                        if (res[0].ProjInfo && typeof res[0].ProjInfo === 'object') {
                            ...
                            // res[0].ProjInfo.coord_x = 116.316424;
                            // res[0].ProjInfo.coord_y = 40.068484
                            ...
                            res[0].ProjInfo.coord_x = latLng.lng;
                            res[0].ProjInfo.coord_y = latLng.lat;
                        }
                        // 附近小区赋值
