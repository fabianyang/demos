...
let page = {
    ...
    listNavigator: function (e) {
        ...
        if (!clickTime || (e.timeStamp - clickTime) >= 1000) {
            let navigatorUrl = (curObj.type && curObj.type == 1 ? '/pages/esf/index/dsindex' : (curObj.housetype === "DS" || curObj.housetype === "YDS") ? '/pages/esf/detail/dsdetail' : '/pages/esf/detail/detail') + '?',
                navUrl, detailParam;
            if (curObj.type && curObj.type == 1) {
                params.type = 1;
                navUrl = navigatorUrl + queryStringify(params);
            } else {
                detailParam = {
                    cityname: this.params.cityname,
                ...
                navUrl = navigatorUrl + queryStringify(detailParam);
            }
