...
<script>
import commonMixin from '@vue-baidu-map/base/mixins/common.js'
import bindEvents from '@vue-baidu-map/base/bindEvent.js'
import {createLabel, createIcon} from '@vue-baidu-map/base/factory.js'
