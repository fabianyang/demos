 ...
 */
define('dsy/search/1.2.4/controller', [
    'jquery',
    'dsy/search/1.2.4/xf',
    'dsy/search/1.2.4/esf',
    'dsy/search/1.2.4/zf',
    'dsy/search/1.2.4/jiaju',
    'dsy/search/1.2.4/kuaixun',
    'dsy/search/1.2.4/fangjia',
    'dsy/search/1.2.4/haiwai',
    'dsy/search/1.2.4/ditu'
    ...
    var allSearch = {
        fangjia: require('dsy/search/1.2.4/fangjia'),
        xf: require('dsy/search/1.2.4/xf'),
        esf: require('dsy/search/1.2.4/esf'),
        zf: require('dsy/search/1.2.4/zf'),
        jiaju: require('dsy/search/1.2.4/jiaju'),
        kuaixun: require('dsy/search/1.2.4/kuaixun'),
        haiwai: require('dsy/search/1.2.4/haiwai'),
        ditu: require('dsy/search/1.2.4/ditu')
    };
    ...
    Prototype.setNavigateTag = function () {
        var parent = this.navigate.parent();
        var id = parent.find('.cur').attr('id');
        // filter ie8 不兼容，对象不支持“exec”属性或方法
