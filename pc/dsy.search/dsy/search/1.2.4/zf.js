...
define('dsy/search/1.2.4/zf', [
    ...
    $.extend(ZFSearch.prototype, new Search());
    ...
    ZFSearch.prototype.searchByKey = function (pKey, data) {
        var that = this,
            key = pKey;
        ...
        if (json && json.purpose === '社区') {
            url = 'http://zu.test.fang.com/house/cm' + json.id + '-kw' + that.encode(key) + '/';
        } else {
