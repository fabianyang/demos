 ...
 */
define('dsy/search/1.2.1/homeSearch', [
    'jquery',
    'dsy/search/1.2.1/tejiaSearch',
    'dsy/search/1.2.1/xfSearch',
    'dsy/search/1.2.1/esfSearch',
    'dsy/search/1.2.1/zfSearch',
    'dsy/search/1.2.1/jiajuSearch',
    'dsy/search/1.2.1/kuaixunSearch',
    'dsy/search/1.2.1/fangjiaSearch',
    'dsy/search/1.2.1/haiwaiSearch'
    ...
    var allSearch = {
        tejia: require('dsy/search/1.2.1/tejiaSearch'),
        fangjia: require('dsy/search/1.2.1/fangjiaSearch'),
        xf: require('dsy/search/1.2.1/xfSearch'),
        esf: require('dsy/search/1.2.1/esfSearch'),
        zf: require('dsy/search/1.2.1/zfSearch'),
        jiaju: require('dsy/search/1.2.1/jiajuSearch'),
        kuaixun: require('dsy/search/1.2.1/kuaixunSearch'),
        haiwai: require('dsy/search/1.2.1/haiwaiSearch')
    };
