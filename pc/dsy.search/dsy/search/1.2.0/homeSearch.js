 ...
 */
define('dsy/search/1.2.0/homeSearch', [
    'jquery',
    'dsy/search/1.2.0/tejiaSearch',
    'dsy/search/1.2.0/xfSearch',
    'dsy/search/1.2.0/esfSearch',
    'dsy/search/1.2.0/zfSearch',
    'dsy/search/1.2.0/jiajuSearch',
    'dsy/search/1.2.0/kuaixunSearch',
    'dsy/search/1.2.0/fangjiaSearch',
    'dsy/search/1.2.0/haiwaiSearch'
    ...
    var allSearch = {
        tejia: require('dsy/search/1.2.0/tejiaSearch'),
        fangjia: require('dsy/search/1.2.0/fangjiaSearch'),
        xf: require('dsy/search/1.2.0/xfSearch'),
        esf: require('dsy/search/1.2.0/esfSearch'),
        zf: require('dsy/search/1.2.0/zfSearch'),
        jiaju: require('dsy/search/1.2.0/jiajuSearch'),
        kuaixun: require('dsy/search/1.2.0/kuaixunSearch'),
        haiwai: require('dsy/search/1.2.0/haiwaiSearch')
    };
