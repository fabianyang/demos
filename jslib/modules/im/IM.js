 ...
 * IM聊天的主界面
 */
define('modules/im/IM',
    ['jquery','modules/im/HTML','iscroll/2.0.0/iscroll-lite','modules/xf/IcoStar','slideFilterBox/1.0.0/slideFilterBox'],
    function (require) {
        'use strict';
        var $ = require('jquery');
        ...
        * 聊天对象
        ...
        Chat.prototype = {
            ...
            initialize: function () {
                ...
                $wrapper.css({height: callHeight,overflow: 'hidden'});
                // 设置聊天框内的内容可以滚动
                chatIscroll();
                // 获取置业顾问的聊天信息
                setTimeout(function () {
