jQuery(document).ready(function ($) {
    ...
    var longUpload = function () {
        longTime = setTimeout(function () {
            // var c = confirm('看样子上传过程很漫长，你可以点击确定重新上传');
            // if (c === true) {
            //     location.reload();
            // }
    ...
    $('.con2').on('click', '.cs_start', function () {
        ...
        setTimeout(function () {
            noScroll = false;
            window.location.href = mainSite + '/activityshow/paPaPa/result.jsp?u=' + pinchPicUrl + '&x=' + transX + '&y=' + transY + '&s=' + scale + '&r=' + ramNum;
        }, 3600);
    });
    ...
    function flashImg() {
        var flashThis = setTimeout(function () {
            ...
            youTuImg.attr('src', 'http://static.test.soufunimg.com/common_m/m_activity/PaPaPa/images/b' + ramNum + '.jpg');
            res();
        }, 3500);
    }
    ...
    if ($('body').hasClass('result')) {
        ...
        if (result.r) {
            ...
            var resultSlogan = [
                ...
                { desc: '皮肤光泽有活力，嘴唇甜蜜诱人', type: '郊区僻静的底层住宅', why: '主要是怕引起自燃灾害', keyword: '郊区，楼层' },
            ...
            var restoreImg = function () {
                $('.youtu').find('img').attr('src', 'http://static.test.soufunimg.com/common_m/m_activity/PaPaPa/images/type' + ramNum + '.jpg');
                flashImg();
            };
            restoreImg();
            ...
            youtuSrc = 'http://static.test.soufunimg.com/common_m/m_activity/PaPaPa/images/type' + boardRandom + '.jpg';
            baomanSrc = 'http://static.test.soufunimg.com/common_m/m_activity/PaPaPa/images/b' + boardRandom + '.jpg';
            var youtuBox = $('<div class="youtu1"><img src="' + youtuSrc + '"></div>')
            youTuImg = youtuBox.find('img');
            $('.tu2').before(youtuBox).remove();
            changeYoutuSrc();
        ...
        searchInput.on('click', function (ev) {
            ev.stopPropagation();
            $('html,body').delay(666).animate({ scrollTop: $('#main').height() }, 233);
        });
